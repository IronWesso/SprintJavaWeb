										...
										<div class="card-body p-md-5 text-black">
											...
											<form method="post" class="form">
												...
												<div class="form-outline mb-4">
													<label class="form-label" for="rut">ID de la Visita a Terreno</label>
	
													<input required min="0" type="number" id="rut" class="form-control form-control-lg" name="rut" max="9999999" min="0"/>
												...
												<div class="form-outline mb-4">
													<label class="form-label" for="lugar">Nombre de la Revisión</label>
												...
												<div class="form-outline mb-4">
													<label class="form-label" for="lugar">Detalle a Revisar</label>
												...
												<div class="form-outline mb-4">
													...
													<select class="form-select">
														<option value="1">Sin Problemas</option>
														<option value="2">Con Observaciones</option>
														<option value="3">No Aprueba</option>
													</select>
