<%@ page language="java" contentType="text/html; charset=utf-8" pageEncoding="utf-8" %>
	...
	<head>
		<meta charset="utf-8">
		<title>Listado Revisiones</title>
		<!-- CSS only -->
		...
		<%@ include file="nav.jsp" %>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
              <div class="col-9 p-3 ">
				...
				<h1 style="padding:10px; text-align:center;">Revisiones</h1>
				
			<table class="table table-dark table-striped border border-light" id="revision">
				<thead>
					<tr>
						<th>ID</th>
						<th>ID Visita</th>
						<th>Nombre</th>
						<th>Detalle a Revisar</th>
						<th>Estado</th>
						<th>Editar</th>
					</tr>
				</thead>
